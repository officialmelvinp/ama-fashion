...
export default function Header({ bgColor = "bg-white/70 backdrop-blur-md shadow-sm", textColor = "text-[#2c2824]" }: HeaderProps) {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full py-4 px-4 md:px-8 transition-all duration-300 ${bgColor}`}
    >
