...
export default function CheckoutClientContent({ initialRegion = "UAE" }: { initialRegion: Region }) {
  ...
  const handleStripeCheckout = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "Stripe checkout failed.",
        variant: "destructive",
      })
    } finally {
  ...
  const handlePayPalCheckout = async () => {
    ...
    try {
      ...
      toast({
        title: "Checkout Error",
        description: error.message || "PayPal checkout failed.",
        variant: "destructive",
      })
    } finally {
      setIsProcessing(false)
  ...
  return (
    <div className="min-h-screen bg-[#f8f3ea]">
      {!isClient ? (
        <div className="flex items-center justify-center min-h-screen bg-[#f8f3ea]">
          <p className="text-[#2c2824] font-serif">Loading checkout...</p>
        </div>
      ) : (
        <>
            ...
            <div className="flex items-center justify-center min-h-[80vh]">
              <div className="text-center">
                <h1 className="text-2xl font-serif mb-4">
                  No Items in Cart for {selectedRegion}
                </h1>
                <Link href="/shop">
            ...
            <div className="container mx-auto py-12 px-4 text-center lg:text-left">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                  ...
                  {/* Shipping & Payment */}
                  <div className="bg-white p-8 rounded-lg shadow-sm">
                    <h2 className="text-xl font-serif mb-6 text-[#2c2824]">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        ...
                        >
                          <div className="font-medium text-[#2c2824] mb-1">
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="text-center text-sm text-[#2c2824]/60 mt-4">
                        ...
                        <p>
                          📱 You&apos;ll receive WhatsApp contact after payment for delivery coordination
                        </p>
                        {paymentMethod === "stripe" && (
                          <div className="text-xs mt-2 space-y-1">
                            <p>
                              💳 {selectedRegion === "UAE" ? "UAE" : "UK"} cards supported • No
                              account required
                            </p>
                        ...
                        {paymentMethod === "paypal" && (
                          <div className="text-xs mt-2">
                            <p>
                              🌍 Works with cards from any country • PayPal handles currency conversion
                            </p>
                          </div>
                        )}
                      </div>
