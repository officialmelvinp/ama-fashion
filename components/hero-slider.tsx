...
export default function HeroSlider() {
  return (
    <section className="relative w-full">
      ...
      {/* ---------------- Desktop Layout ---------------- */}
      <div className="hidden md:flex container mx-auto px-6 md:px-12 flex-row items-center justify-between gap-12 py-28">
        ...
        <motion.div
          ...
          className="w-1/2 flex flex-col justify-center text-center md:text-center relative z-20"
        >
          <div className="absolute inset-0 bg-gradient-to-tr from-[#FDE68A] via-[#FECACA] to-[#FBBF24] -z-10 rounded-3xl shadow-2xl opacity-95 hidden md:block" />
          <h1 className="font-serif text-7xl lg:text-8xl font-light tracking-wider leading-tight mb-6 text-[#2c2824]">
            SOULFULLY MADE.
            <br />
            ELEVATED ESSENTIALS.
          </h1>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1 }}
          className="w-1/2 h-[500px] relative rounded-3xl overflow-hidden shadow-xl"
        >
          <Swiper
      ...
      {/* ---------------- Mobile Layout ---------------- */}
      <div className="flex md:hidden h-screen flex-col items-center justify-center text-center text-white">
