          ...
          <div className="grid gap-24">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div className="relative aspect-square mt-8 md:mt-0">
                  <Image
            ...
            <section>
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div className="order-1 md:order-2 text-center md:text-left md:mt-16">
                ...
                {/* Image - will be second on mobile, first on desktop */}
                <div className="relative aspect-square order-2 md:order-1 mt-8 md:mt-0">
                  <Image
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              {/* Our Materials */}
              <section className="flex flex-col text-center md:text-left mt-12 md:mt-0">
