...
export default function WhyAMAPage() {
          ...
          <div className="grid gap-24">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                {/* Updated heritage image with wider width on desktop */}
               <div className="relative w-full h-64 md:h-80 mt-10 md:-mt-8">
  <Image
  ...
  />
            ...
            <section>
              ...
              <section className="-mt-12 md:-mt-20"></section>
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                {/* Image - reduced top margin on mobile */}
                <div className="relative aspect-square order-2 md:order-1 mt-4 md:mt-0">
                  <Image
            ...
            <div className="grid md:grid-cols-2 gap-16 -mt-12 md:-mt-20">
              {/* Our Manifestation */}
              ...
              {/* Our Materials - reduced top margin on mobile */}
              <section className="flex flex-col text-center md:text-left mt-6 md:mt-0">
            ...
            <section className="-mt-8">
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div className="relative aspect-video bg-[#f4f0e8] rounded-lg flex items-center justify-center mt-8 md:mt-0">
