...
export default function AdminDashboard() {
  ...
  return (
    <>
      {/* Dashboard Title and Description - now part of the page content, not a separate header */}
      <div className="mb-8">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link href="/admin/analytics">
            {" "}
            {/* Changed from /admin/dashboard to /admin/analytics */}
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <CardContent className="p-6 text-center">
                <Users className="h-8 w-8 text-[#2c2824] mx-auto mb-2" />
                <h3 className="font-medium text-[#2c2824]">View Analytics</h3> {/* Changed text */}
                <p className="text-sm text-gray-500 mt-1">Analyze sales and subscriber data</p> {/* Changed text */}
              </CardContent>
            </Card>
          </Link>
        </div>
